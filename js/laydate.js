$(function () {
    ...
    for (var i = 1990; i < 2099; i++) {
        yearArr.push(i + "骞�");
        $("#yearList").append('<option value="' + (i + "骞�") + '">' + i + "年" + "</option>")
    }
    for (var j = 1; j < 13; j++) {
        monthArr.push(j + "鏈�");
        $("#monthList").append('<option value="' + (j + "鏈�") + '">' + j + "月" + "</option>")
    }
    var d = new Date();
    ...
    $("#yearList").val(currYear + "骞�");
    $("#monthList").val(currMonth + "鏈�");
    ...
    $("#yearList,#monthList").on("change", function (e) {
        ergodicDate($("#yearList").val().split("骞�")[0], $("#monthList").val().split("鏈�")[0]);
        $("#laydateInput").val($("#yearList").val().split("骞�")[0] + " - " + $("#monthList").val().split("鏈�")[0] + " - " + currDate);
        getSelectDate($("#yearList").val().split("骞�")[0] + " - " + $("#monthList").val().split("鏈�")[0] + " - " + currDate)
    });
    $(".day-tabel").on("click", ".tabel-li", function (e) {
        ...
        if (parentIndex == 0 && $(this).html() > 7) {
            var selectDate;
            if (($("#monthList").val().split("鏈�")[0] - 1) > 0) {
                selectDate = $("#yearList").val().split("骞�")[0] + " - " + ($("#monthList").val().split("鏈�")[0] - 1) + " - " + $(this).html();
                ergodicDate($("#yearList").val().split("骞�")[0], ($("#monthList").val().split("鏈�")[0] - 1));
                $("#yearList").val($("#yearList").val().split("骞�")[0] + "骞�");
                $("#monthList").val(($("#monthList").val().split("鏈�")[0] - 1) + "鏈�")
            } else {
                selectDate = ($("#yearList").val().split("骞�")[0] - 1) + " - " + 12 + " - " + $(this).html();
                ergodicDate(($("#yearList").val().split("骞�")[0] - 1), 12);
                $("#yearList").val(($("#yearList").val().split("骞�")[0] - 1) + "骞�");
                $("#monthList").val(12 + "鏈�")
            }
        } else {
            if (parentIndex == currK && $(this).html() < 7) {
                if (parseInt($("#monthList").val().split("鏈�")[0]) + 1 > 12) {
                    selectDate = (parseInt($("#yearList").val().split("骞�")[0]) + 1) + " - " + 1 + " - " + $(this).html();
                    ergodicDate($("#yearList").val().split("骞�")[0], ($("#monthList").val().split("鏈�")[0] - 1));
                    $("#yearList").val((parseInt($("#yearList").val().split("骞�")[0]) + 1) + "骞�");
                    $("#monthList").val(1 + "鏈�")
                } else {
                    selectDate = ($("#yearList").val().split("骞�")[0]) + " - " + (parseInt($("#monthList").val().split("鏈�")[0]) + 1) + " - " + $(this).html();
                    ergodicDate(($("#yearList").val().split("骞�")[0]), (parseInt($("#monthList").val().split("鏈�")[0]) + 1));
                    $("#yearList").val(($("#yearList").val().split("骞�")[0]) + "骞�");
                    $("#monthList").val((parseInt($("#monthList").val().split("鏈�")[0]) + 1) + "鏈�")
                }
            } else {
                selectDate = $("#yearList").val().split("骞�")[0] + " - " + $("#monthList").val().split("鏈�")[0] + " - " + $(this).html()
            }
        }
